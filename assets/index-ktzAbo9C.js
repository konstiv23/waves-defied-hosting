...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Bp(i,t,e){const n=new Float32Array(Xn),r=new D(0,1,0);return new We({name:"SphericalGaussianBlur",defines:{n:Xn,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Jr(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Yo(){return new We({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Jr(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Zo(){return new We({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jr(),fragmentShader:`
...
}`,ml=-1e4,M_=new We({uniforms:{uFogColor:{value:new Zt(16777215)},uFogDensity:{value:.012}},vertexShader:x_,fragmentShader:S_,transparent:!0,opacity:.75});class E_{trackShape;world;id;constructor(t,e){this.id=e,this.world=t,this.trackShape=new v_,this.genWallMesh()}genWallMesh(){const t=this.trackShape.points,e=new Jl;e.moveTo(0,ml);for(let s=0;s<t.length;s++)e.lineTo(t[s].x,t[s].y);e.lineTo(t.at(-1).x,ml);const n=new Ka(e),r=new Ie(n,M_);r.position.z=.1,r.renderOrder=1,this.world.scene.add(r)}}class y_{leftRight=0;constructor(){}}const je=new y_;function sr(i){const t=T_(i.track.trackShape.points,i.player.pos.x);return t===-1?null:t}function T_(i,t){let e=0,n=i.length-1,r=-1;for(;e<=n;){const s=Math.floor((e+n)/2);i[s].x<=t?(r=s,e=s+1):n=s-1}return r}class b_{player;world;constructor(t){this.player=t,this.world=t.world}update(){this.#e(),this.#n(),this.#t()}#e(){const t=this.getWaveVec(),e=this.#r();if(e){const n=this.player.pos.clone().sub(e).length();this.player.pos.copy(e.clone().add(t.clone().multiplyScalar(n)))}this.player.physicsBody.applyForce(t.clone().multiplyScalar(a_*je.leftRight))}#t(){const e=this.getWaveVec().applyAxisAngle(new D(0,0,1),Math.PI/2),n=this.#i(),r=e.dot(n),s=e.clone().multiplyScalar(-r);this.player.physicsBody.applyForce(s)}#n(){this.player.physicsBody.applyForce(this.#i())}#i(){return new D(0,-gc*_c,0)}tryTakeOff(){const t=this.#r();if(!t)return!1;const e=this.getWaveVec(),n=t.clone().add(e),r=t.x,s=t.y,a=n.x,o=n.y;if(a===r)return!1;const l=(o-s)/(a-r)*(this.player.pos.x-r)+s;return this.player.pos.y-l>=1e-4?(this.player.state=jr.InAir,!0):!1}getWaveVec(){const t=sr(this.player.world),e=this.world.track.trackShape.points;return t===null||t>=e.length-1?new D(1,0,0):e[t+1].clone().sub(e[t]).normalize()}#r(){const t=sr(this.player.world);return t===null?null:this.player.world.track.trackShape.points[t]}}class vc{static#e=document.querySelector("#debug-info");static setText(t){vc.#e.textContent=t.toString()}}class A_{player;world;constructor(t){this.player=t,this.world=t.world}update(t){this.accel(t),this.tryLand()}tryLand(){const t=this.wavePointStart();if(!t)return;const e=this.getWaveVec(),n=t.clone().add(e),r=t.x,s=t.y,a=n.x,o=n.y;if(a===r)return;(o-s)/(a-r)*(this.player.pos.x-r)+s>=this.player.pos.y&&(this.player.state=jr.InWater)}accel(t){const e=this.player.speed;let n=gc*t;e.y-=n/2,this.player.pos.add(this.player.speed.clone().multiplyScalar(t)),e.y-=n/2,this.player.pos.x<=xi&&(this.player.pos.x=xi)}getWaveVec(){const t=this.world.track.trackShape.points,e=sr(this.player.world);return e===null||e>=t.length-1?new D(1,0,0):t[e+1].clone().sub(t[e]).normalize()}wavePointStart(){const t=sr(this.player.world);return t===null?null:this.player.world.track.trackShape.points[t]}}class w_{player;world;#e=[];constructor(t){this.player=t,this.world=t.world}update(t){this.#n(),this.#i(),this.#t(t),this.#e=[]}applyForce(t){this.#e.push(t.clone())}#t(t){if(this.player.pos.x<=xi&&this.player.speed.x<0&&je.leftRight<0){this.player.pos.x=xi;return}const e=new D(0,0,0);this.#e.forEach(a=>e.add(a));const s=e.clone().multiplyScalar(1/_c).clone().multiplyScalar(t).clone().multiplyScalar(.5);this.player.speed.add(s),this.player.pos.add(this.player.speed.clone().multiplyScalar(t)),this.player.speed.add(s),this.player.pos.x<=xi&&(this.player.pos.x=xi)}#n(){this.player.speed.multiplyScalar(h_)}#i(){const t=this.player.speed.clone(),e=t.clone().normalize(),n=t.length(),r=d_*n**f_,s=e.clone().multiplyScalar(-r);this.applyForce(s)}}const R_=""+new URL("hpgruesen-jet-ski-6669543_no_bg-BqqSQ5pd.webp",import.meta.url).href,gl=3.5;function xc(i,t){const e=new Pn;return e.add(C_(t)),i.add(e),e}function C_(i){const t=new Pn,n=new kh().load(R_);n.colorSpace=Ce;const r=new or(1,1),s=new Di({map:n,transparent:!0,opacity:i,side:Ke,depthTest:!1}),a=new Ie(r,s);return a.position.set(.45,.4,0),t.add(a),t.scale.set(gl,gl,1),t}class P_{leftRight=0;constructor(){this.initTouchTilt(),document.addEventListener("keydown",t=>{switch(t.code){case"ArrowUp":case"KeyW":t.preventDefault();break;case"ArrowLeft":case"KeyA":t.preventDefault(),this.leftRight=-1,je.leftRight=1;break;case"ArrowRight":case"KeyD":t.preventDefault(),je.leftRight=1,this.leftRight=1;break}}),document.addEventListener("keyup",t=>{switch(t.code){case"ArrowUp":case"KeyW":t.preventDefault();break;case"ArrowLeft":case"KeyA":t.preventDefault(),this.leftRight===-1&&(this.leftRight=0);break;case"ArrowRight":case"KeyD":t.preventDefault(),this.leftRight===1&&(this.leftRight=0);break}})}initTouchTilt(){const t=document.querySelector("#left"),e=document.querySelector("#right");let n=!1,r=0,s=0;t.addEventListener("touchstart",a=>{a.preventDefault(),je.leftRight=1,this.leftRight=-1,r++,t.classList.add("active"),e.classList.remove("active")}),t.addEventListener("touchend",a=>{try{if(r--,this.leftRight===-1||n)if(!(n&&this.leftRight===-1)||r===0)this.leftRight=0,n=!1,e.classList.remove("active"),t.classList.remove("active"),s&&(this.leftRight=1,e.classList.add("active"));else{let o=e.getBoundingClientRect();a.targetTouches[0].pageX-o.left>0&&(this.leftRight=1,t.classList.remove("active"),e.classList.add("active"))}a.targetTouches.length<=1&&(n=!1,this.leftRight=0,r=0,s=0)}catch{n=!1,this.leftRight=0,r=0,s=0}}),t.addEventListener("touchmove",a=>{try{if(s)return;let o=t.getBoundingClientRect(),l=o.width;a.targetTouches[0].pageX-o.left>l?n||(t.classList.remove("active"),e.classList.add("active"),this.leftRight=1,n=!0):(n=!1,e.classList.remove("active"),t.classList.add("active"),this.leftRight=-1)}catch{}}),e.addEventListener("touchstart",a=>{a.preventDefault(),je.leftRight=1,s++,e.classList.add("active"),t.classList.remove("active"),this.leftRight=1}),e.addEventListener("touchend",a=>{try{if(s--,this.leftRight===1||n)if(!(n&&this.leftRight===1)||s===0)t.classList.remove("active"),e.classList.remove("active"),this.leftRight=0,n=!1,r&&(this.leftRight=-1,t.classList.add("active"));else{let o=t.getBoundingClientRect(),l=o.width;a.targetTouches[0].pageX-o.left<l&&(this.leftRight=-1,t.classList.add("active"),e.classList.remove("active"))}a.targetTouches.length<=1&&(n=!1,this.leftRight=0,r=0,s=0)}catch{n=!1,this.leftRight=0,r=0,s=0}}),e.addEventListener("touchmove",a=>{try{if(r)return;let o=e.getBoundingClientRect();a.targetTouches[0].pageX-o.left<0?n||(e.classList.remove("active"),t.classList.add("active"),this.leftRight=-1,n=!0):(t.classList.remove("active"),e.classList.add("active"),this.leftRight=1,n=!1)}catch{}})}}const Yr=new P_;class L_{player;#e=0;#t=0;#n=0;inputOffset=0;cachedDisplayAngle=0;constructor(t){this.player=t}update(t){this.inputOffset-=Yr.leftRight*t*o_,this.player.state===jr.InWater&&(this.inputOffset=Dn.clamp(this.inputOffset,-pl,pl)),this.player.obj3d.rotation.z=this.#i(t)}#i(t){const n=1-Math.pow(.008,t);this.#t=Dn.lerp(this.#t,this.#e,n);const r=this.#t+this.inputOffset;return this.cachedDisplayAngle=r,r}setBase(t){this.#n=this.#e,this.#e=t}setPrevBase(){this.#e=this.#n}}var jr=(i=>(i[i.InWater=0]="InWater",i[i.InAir=1]="InAir",i))(jr||{});class D_{pos;speed=new D(0,0,0);state=0;obj3d;world;inWater;inAir;physicsBody;tilt;takeOffTimeStamp=-1/0;constructor(t){this.world=t,this.obj3d=xc(t.scene,1),this.pos=this.obj3d.position,this.inWater=new b_(this),this.inAir=new A_(this),this.physicsBody=new w_(this),this.tilt=new L_(this)}update(t){switch(this.state){case 0:this.inWater.update(),this.physicsBody.update(t);const e=this.inWater.tryTakeOff();if(e){const n=new D(0,0,1);this.speed.applyAxisAngle(n,this.tilt.inputOffset*l_)}e?(this.takeOffTimeStamp=performance.now(),this.tilt.setPrevBase()):this.setTiltBase();break;case 1:this.inAir.update(t),this.state===0&&(performance.now()-this.takeOffTimeStamp)/1e3>c_&&(this.tilt.inputOffset=0);break}this.tilt.update(t)}setTiltBase(){const t=this.inWater.getWaveVec();let e=new D(1,0,0).angleTo(t);t.y<0&&(e=-e),this.tilt.setBase(e)}init3d(){}}class I_{#e=document.querySelector("#timer");#t=null;stopped=!1;constructor(){this.#e.textContent="0"}start(t){this.#t===null&&(this.#t=t)}update(t){if(this.stopped)return;const e=this.timeSeconds(t);e===0?this.#e.textContent="0":this.#e.textContent=e.toFixed(3)}timeSeconds(t){return this.#t===null?0:(t-this.#t)*pn}stop(t){this.update(t),this.stopped=!0}started(){return this.#t!==null}}async function U_(i){return new Promise((t,e)=>{const n=indexedDB.open(i.name,i.version);n.onerror=()=>{e(n.error??new Error("Failed to open IndexedDB"))},n.onupgradeneeded=r=>{console.log("Upgrading database");const s=n.result,a=new Set;Array.from(s.objectStoreNames).forEach(o=>{i.stores.some(l=>l.name===o)?a.add(o):(s.deleteObjectStore(o),console.log(`Deleted store ${o}`))}),i.stores.forEach(o=>{if(a.has(o.name))return;const l=s.createObjectStore(o.name,{keyPath:o.keyPath,autoIncrement:o.autoIncrement??!1});o.indexes&&o.indexes.forEach(c=>{l.createIndex(c.name,c.keyPath,{unique:c.unique??!1})})})},n.onsuccess=()=>{const r=n.result;r.onerror=s=>{console.error("Database error:",s.target?.error?.message)},t(r)},n.onblocked=()=>{e(new Error("Database opening blocked (possibly by another tab)"))}})}let $a=null;const N_=(async function(){try{$a=await U_(m_),console.log("Database opened successfully")}catch(i){const t=`Failed to open app's database: ${i}`;throw console.error(t),alert(t),i}})();async function F_(i){try{const n=$a.transaction([rr],"readwrite").objectStore(rr).put(i);return new Promise((r,s)=>{n.onsuccess=()=>{console.log("Playback saved to database"),r()},n.onerror=()=>{console.log("Error saving playback"),s(n.error)}})}catch(t){console.error("Error saving playback",t)}}class O_{times=[];positions=[];angles=[];constructor(t){t&&(this.times=t.times,this.positions=t.positions,this.angles=t.angles)}recordFrame(t,e){const n=t*pn;this.times.push(n),this.positions.push(e.pos.clone()),this.angles.push(e.tilt.cachedDisplayAngle)}async save(t,e){try{const n=this.times.at(-1);if(!n||n>i_)return;const r=!t.ghost,s=t.ghost&&t.ghost.trackTime()>n;(r||s)&&await F_({track_id:t.track.id,finishPos:e,...this})}catch(n){console.error("Failed to save playback",n)}}}class B_{record;obj3d;constructor(t,e){this.record=t,this.obj3d=xc(e,u_)}update(t){const e=t*pn,n=z_(this.record.times,e);if(n===-1)return;const r=this.record.positions[n],s=this.record.angles[n];r===void 0||s===void 0||(this.obj3d.position.copy(r),this.obj3d.position.z-=.1,this.obj3d.rotation.z=s)}trackTime(){const t=this.record.times.at(-1);return t||1/0}}function z_(i,t){let e=0,n=i.length-1,r=-1;for(;e<=n;){const s=Math.floor((e+n)/2);i[s]<=t?(r=s,e=s+1):n=s-1}return r}async function V_(i){try{return await G_(i)}catch(t){console.error("Error reading playback:",t)}return null}async function G_(i){return new Promise((t,e)=>{const s=$a.transaction([rr],"readonly").objectStore(rr).get(i);s.onerror=()=>{const a=new Error("Playback not found");console.error(a),e(a)},s.onsuccess=()=>{const a=s.result;if(!a){e("Playback is null or undefined");return}t(a)}})}const Fr=new D(.68,9,.01),Gi=.9,H_=7,_l=5,vl=new Ii,k_=new Di({color:new Zt("brown")}),W_=new Di({color:0}),X_=new Di({color:14540253});class q_{pos;constructor(t,e){const n=new Pn,r=new Ie(vl,k_);r.scale.copy(Fr),r.position.y+=Fr.y/2,r.position.z=-.3,n.add(r);const s=this.genCloth();n.add(s),e.add(n),this.pos=n.position,this.pos.copy(t)}genCloth(){const t=new Pn;for(let e=0;e<H_;e++)for(let n=0;n<_l;n++){const r=(e+n)%2===0?X_:W_,s=new Ie(vl,r);s.scale.set(Gi,Gi,.01),s.position.x=(e+.5)*Gi+Fr.x/2,s.position.y=n*Gi,s.position.y+=Fr.y-(_l-.5)*Gi,s.position.z=-.3,t.add(s)}return t}}class Sc{scene=Hg();track;player;timer=new I_;currentPlayback;ghost=null;finishFlag=null;constructor(t){t&&(this.ghost=new B_(t,this.scene),this.ghost.update(0)),this.ghost&&(this.finishFlag=new q_(this.ghost.record.finishPos,this.scene)),this.track=new E_(this,Le.val),this.player=new D_(this),this.player.pos.x=-1.5,this.currentPlayback=new O_(void 0)}updateGhost(t){this.ghost&&this.ghost.update(t)}}const Y_="waves-record_";class Ci{static submit(t,e){const n=Ci.read(t);n===null?this.#e(t,e):e<n&&this.#e(t,e)}static read(t){const e=localStorage.getItem(this.#t(t));if(e===null)return null;const n=parseFloat(e);return isNaN(n)?null:n}static#e(t,e){localStorage.setItem(Ci.#t(t),e.toString())}static#t(t){return`${Y_}${t}`}}const Os=[25,24,23.5,23,22.75,22.5,22.25,22,21.75,21.5,21.25,21,20.75,20.5,20.25,20,19.75,19.5,19.25,19,18.75,18.5,18.25,18,17.75,17.5,17.25,17,16.75,16.5,16.25,16,15.75,15.5,15.25,15,14.75,14.5,14.25,14,13.75,13.5,13.25,13,12.75,12.5,12.25,12,11.75,11.5,11.25,11,10.75,10.5,10.25,10];class xl{static rate(t){if(t>Os[0])return 0;let e=0;for(;t<Os[e]&&e<Os.length;)e++;return e}}class Z_{#e=document.querySelector("#track-select-dialog");#t=document.querySelector("#tracks");#n=0;visible=!1;constructor(){this.show()}show(){this.#i(),this.#e.showModal(),this.visible=!0,this.#e.scrollTop=this.#n}hide(){this.#e.close(),this.visible=!1}#i(){this.#t.replaceChildren();const t=K_(Yn.ids);let e=0;for(let n of t){const r=this.#r(n,e*3);this.#t.append(...r),e++}this.#t.append(this.#s("Comment how many stars you've got (or anything), pretty please!"))}#r(t,e){const n=[];n.push(this.#a(t,e));let r=0;for(let s of t){const a=this.#o(s,e+r);n.push(a),r++}return n}#a(t,e){let n=0;for(let a of t){const o=Ci.read(a);o!==null&&(n+=xl.rate(o))}const r=`Tracks ${e+1} — ${e+3}: ⭐×${n}`,s=this.#s(r);return s.classList.add("chunk-header"),s}#o(t,e){const n=document.createElement("button");n.appendChild(this.#s(`Track ${e+1}`));const r=Ci.read(t);if(r!==null)n.appendChild(this.#s(r.toFixed(3)+"s")),n.appendChild(this.#l(r));else{const s=this.#s("⭐×0");s.classList.add("faded"),n.appendChild(s)}return Le.val===t&&n.classList.add("highlight"),n.id=t,n.addEventListener("click",()=>{this.#n=this.#e.scrollTop,Le.val=t,document.dispatchEvent(new CustomEvent("restartgame")),this.hide()}),n}#s(t){const e=document.createElement("div");return e.innerText=t,e}#l(t){const e=xl.rate(t);let n=`⭐×${e}`;const r=this.#s(n);return e===0&&r.classList.add("faded"),r}}const K_=i=>{const t=[];for(let e=0;e<i.length;e+=3)t.push(i.slice(e,e+3));return t},Mc=new Z_;class Ec{physicsFrame=0;playbackSaved=null;#e=0;#t;#n;constructor(t,e){this.#t=t,this.#n=e}update(t){if(!this.#i())return;this.#e+=t;let e=0;for(;this.#e>=pn&&e<mc;){if(this.#t.player.update(pn),this.#t.timer.update(this.physicsFrame),this.#a(this.physicsFrame),this.#t.timer.stopped){this.#r();return}this.physicsFrame%n_===0&&this.#r(),this.#e-=pn,this.physicsFrame++,e++}}#i(){return(je.leftRight!==0||Yr.leftRight!==0)&&this.#t.timer.start(this.physicsFrame),this.#t.timer.started()?!0:(this.#e=0,!1)}#r(){this.#t.currentPlayback.recordFrame(this.physicsFrame,this.#t.player)}#a(t){const e=this.#t;if(e.timer.stopped)return;let n=!1;if(this.#n&&t*pn>=r_&&(n=!0),this.playerRunEnded()||n)if(e.timer.stop(t),n){this.playbackSaved=e.currentPlayback.save(e,this.getBotFinishPos());return}else{if(!e.ghost)throw new Error("Ghost run must exist during player run, it doesn't");this.playbackSaved=e.currentPlayback.save(e,e.ghost.record.finishPos)}}playerRunEnded(){if(this.#n)return!1;if(!this.#t.ghost)throw new Error("Ghost run must exist during player run, it doesn't");const t=this.#t.ghost.record.finishPos.x,e=this.#t.player.pos.x>=t;return e&&(setTimeout(()=>Mc.show(),p_*1e3),Ci.submit(Le.val,this.physicsFrame*pn)),e}getBotFinishPos(){const t=this.#t,e=sr(t);let n=t.player.pos.y;const r=t.track.trackShape.points;if(e!==null&&(n=r[e].y),e!==null&&e<r.length-1){let s=r[e].clone(),a=r[e+1].clone();const o=Dn.inverseLerp(s.x,a.x,t.player.pos.x);n=Dn.lerp(s.y,a.y,o)}return new D(t.player.pos.x,n,0)}}function J_(){return navigator.userAgentData!==void 0?navigator.userAgentData.mobile:/Mobi|Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}function $_(){const i=document.querySelector("#pc-controls"),t=document.querySelector("#touch-controls");J_()?i.style.display="none":t.style.display="none"}const ja={};ja.ru={"how-to-play":"Чтобы плыть быстро и зарабатывать звёзды, наклоняйся так, чтобы прыгать максимально далеко вперёд",tilt:"НАКЛОН"};ja.es={"how-to-play":"Para dejar atrás al fantasma y ganar estrellas, inclínate para saltar lo más adelante posible",tilt:"Inclinación"};const j_="en";function Q_(){let i=navigator?.language;return i?t0(i):j_}const Sl=/[-_]/;function t0(i){return Sl.test(i)?i.split(Sl)[0]:i}async function e0(){const i=Q_(),t=ja[i];t&&(document.documentElement.setAttribute("lang",i),document.querySelectorAll("[data-i18n]").forEach(e=>{const n=e.getAttribute("data-i18n"),r=t[n];r!==void 0&&(e.innerText=r)}))}let Qe,Ei,Da,Ia=0;function yc(i){Ia=requestAnimationFrame(yc);let t=(i-Da)/1e3;t=Math.min(t,pn*mc),Da=i,!Qe.timer.stopped&&!Mc.visible&&Ei.update(t),qg(t,Qe),Qe.updateGhost(Ei.physicsFrame),Jn.render(Qe.scene,Pe)}async function $n(){await N_;const i=await V_(Le.val);if(i===null){await n0(),$n();return}Qe=new Sc(i),Ei=new Ec(Qe,!1),Yg(Qe),je.leftRight=0,Da=performance.now(),cancelAnimationFrame(Ia),Ia=requestAnimationFrame(yc)}async function n0(){for(Qe=new Sc(null),Ei=new Ec(Qe,!0),await Ei.playbackSaved;!Qe.timer.stopped;)Yr.leftRight=1,je.leftRight=1,Ei.update(1/60),Yr.leftRight=0,je.leftRight=0}document.addEventListener("keydown",i=>{switch(i.code){case"KeyR":i.preventDefault(),$n();break;case"NumpadAdd":i.preventDefault();const t=Yn.ids.findIndex(e=>e===Le.val);t!==-1&&t<Yn.ids.length-1&&(Le.val=Yn.ids[t+1],$n());break;case"NumpadSubtract":{i.preventDefault();const e=Yn.ids.findIndex(n=>n===Le.val);e!==-1&&e>0&&(Le.val=Yn.ids[e-1],$n());break}}});document.addEventListener("restartgame",$n);const i0=document.querySelector("#restart-button");i0.addEventListener("click",$n);$_();e0();$n();
